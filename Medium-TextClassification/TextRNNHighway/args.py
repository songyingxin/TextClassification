...
def get_args(data_dir, cache_dir, embedding_folder, model_dir, log_dir):
    ...
    parser.add_argument("--model_name", default="TextRNNHighway",
    ...
    # 输出文件名
    parser.add_argument(
        "--model_dir", default=model_dir + "TextRNNHighway/", type=str, help="输出模型的保存地址"
    )
    parser.add_argument(
        "--log_dir", default=log_dir + "TextRNNHighway/", type=str, help="日志文件地址"
    )
