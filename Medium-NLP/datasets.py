...
parser.add_argument('-shuffle', action='store_true',
                    default=False, help='shuffle the data every epoch')
# model
...
parser.add_argument('-static', action='store_true',
                    default=False, help='fix the embedding')
# device
...
train_iter, dev_iter, test_iter = sst(
    text_field, label_field, device=-1, repeat=False)
